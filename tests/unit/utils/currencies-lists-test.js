...
module('Unit | Utility | currencies list | CURRENCIES_LIST');
...
module('Unit | Utility | currencies list | CURRENCIES_PER_COUNTRY_LIST');
...
module('Unit | Utility | currencies list | DEFAULT');
